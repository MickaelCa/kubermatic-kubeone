...
func baseResources() map[Resource]map[string]string {
	return map[Resource]map[string]string{
		...
		MachineController:      {"*": "ghcr.io/mickaelca/kubermatic-machine-controller:v1.58.1"},
		MetricsServer:          {"*": "registry.k8s.io/metrics-server/metrics-server:v0.6.4"},
		OperatingSystemManager: {"*": "ghcr.io/mickaelca/kubermatic-operating-system-manager:v1.4.0"},
	}
}
